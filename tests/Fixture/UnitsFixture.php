...
class UnitsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'category' => ['type' => 'string', 'length' => 256, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_units_category_idx' => ['type' => 'index', 'columns' => ['category'], 'length' => ['category' => '255']],
        ],
        '_constraints' => [
