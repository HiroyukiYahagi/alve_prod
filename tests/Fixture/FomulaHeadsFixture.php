 ...
 *
 */
class FomulaHeadsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_fomua_heads_allocation_id_idx' => ['type' => 'index', 'columns' => ['allocation_id'], 'length' => []],
            'fk_fomua_heads_category_idx' => ['type' => 'index', 'columns' => ['unit_category'], 'length' => ['unit_category' => '255']],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_fomua_heads_allocation_id' => ['type' => 'foreign', 'columns' => ['allocation_id'], 'references' => ['allocations', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
